...
(def single-plate
  (let [top-wall (->> (cube (+ keyswitch-width 3) 1.5 plate-thickness)
        ...
        top-nub (->> (cube 11 11 retention-tab-hole-thickness)
...
(def usb-holder (mirror [-1 0 0]
                    (import "../things/usb_holder_rp2040.stl")))

(def usb-holder (translate [-38 46 bottom-height] usb-holder))
...
(def screw-head-height 3.5)
(def layer-height 0.05)
(def bottom-screw-holes-head
  (translate [0 0 (- bottom-height)] (screw-insert-all-shapes 3.5 1.75 screw-head-height)))
